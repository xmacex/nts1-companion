...
-- SYSEX stuff, e.g. for dealing with custom oscillators and effects
...
Nts1.get_program_info = function(channel, slot_type, slot_number)
  Nts1.send_sysex({0x42, 0x30 + channel - 1, 0x00, 0x01, 0x57, 0x19, 0x00 + slot_type, 0x00 + slot_number})
